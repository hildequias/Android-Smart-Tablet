...
public class MainActivity extends LifecycleLoggingActivity {
    ...
    protected void onActivityResult(int requestCode,
        ...
        if (RESULT_OK == resultCode) {
            ...
            if (DOWNLOAD_IMAGE_REQUEST == requestCode) {
                ...
                // file.
                // @@ TODO -- you fill in here.
            	Intent intent = makeGalleryIntent(data.getDataString().toString());
        ...
        // code.
        	...
        	Toast.makeText(this, "Activity did not complete successfully", Toast.LENGTH_SHORT).show();
        }
    }    
    ...
    private Intent makeGalleryIntent(String pathToImageFile) {
    	...
    	Uri uri = Uri.fromFile(new File(pathToImageFile));
