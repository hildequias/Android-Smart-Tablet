...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<Integer> mFriendIds = this.getArguments().getIntegerArrayList(TAG_FRIEND_RES_IDS);

		// TODO: Start the DownloaderTask
		task.execute(mFriendIds);
	...
	public class DownloaderTask extends AsyncTask<ArrayList<Integer>, Void, String[]>{
		...
		protected String[] doInBackground(ArrayList<Integer>... params) {
			return downloadTweets(convertIntegers(params));
		}
		...
		protected Integer[] convertIntegers(ArrayList<Integer>... params){
					...
					new BroadcastReceiver() {
						...
						public void onReceive(Context context, Intent intent) {
							...
							if (getResultCode() != MainActivity.IS_ALIVE) {
                                ...
                                notiManager.notify(MY_NOTIFICATION_ID, 
